package com.lzg.netty.websocket;// Generated by the protocol buffer compiler.  DO NOT EDIT!
...
public final class StudentPOJO {
  ...
  public interface StudentOrBuilder extends
    ...
    /**
     * <pre>
     *  Student类中一个属性，名叫id，类型为int32,1表示属性序号而不是值
     * </pre>
     *
  ...
  /**
   * <pre>
   *会在这个外部类中生成一个内部类Student，它才是真正发送的POJO对象
   * </pre>
   *
